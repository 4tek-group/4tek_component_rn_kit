...
const Carousel = forwardRef(
  (
    ...
    const pageWidth = useMemo(
      ...
      [data.length, itemWidth, sliderWidth],
    )
    useImperativeHandle(
      ref,
      () => ({
      ...
      [data.length, scrollX, sliderWidth],
    )
    ...
    }, [data, autoplay, delay, scrollX, sliderWidth])
    ...
    const renderPageIndicator = useCallback(
      ...
      [indicatorItemStyle, indicatorType, pageWidth, scrollX],
    )
    return (
      <View
        style={{
